                    ...
                    <div class="panel-body">
                         <form role="form" action="" method="POST">
                            ...
                            <div class="form-group">
                              ...
                              <select name="idjabatan" class="form-control" required onchange='ubah(this.value)'>
                                <option disabled selected>Pilih</option>
                              <?php
                                $epep = mysqli_query($kon, "SELECT * FROM jabatan ORDER BY jabatannya ASC");
                                $a    = "var gaji = new Array();\n;";
                                  while($bocil = mysqli_fetch_array($epep)) {
                                    echo "<option value='$bocil[idjabatan]'>$bocil[jabatannya]</option>";
                                    $a .= "gaji['" . $bocil['idjabatan'] . "'] = {gaji:'" . addslashes($bocil['gaji'])."'};\n";
                                  } 
                                ?>
                            </select>
                            </div>
                            <div class="form-group">
                              <label>Gaji</label>
                              <input type="number" class="form-control" id="gaji" name="gaji" readonly>
                            </div>
                            <div class="form-group">
...
<?php
  if (isset($_POST['simpan'])) {
    ...
    $tambah = mysqli_query($kon,"INSERT INTO gaji(gajinya,tgl,id,total,ket,idjabatan,tunjangan) VALUES ('$gaji','$tgl','$id','$total','$ket','$idjabatan','$tunjangan')");
    if($tambah){
