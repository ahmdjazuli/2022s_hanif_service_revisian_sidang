        ...
        <div class="modal-content modal-sm" style="margin:0 auto">
            ...
            <div class="modal-body">
                ...
                <select name="bulan" class="form-control">
                  ...
                  <?php
                    $ahay = mysqli_query($kon, "SELECT DISTINCT MONTH(tglkeluar) as bulan FROM inventorikeluar ORDER BY bulan ASC");
                ...
                <select name="tahun" class="form-control" required>
                  <?php
                    $ahay = mysqli_query($kon, "SELECT DISTINCT YEAR(tglkeluar) as tahun FROM inventorikeluar ORDER BY tahun ASC");
                    while($baris = mysqli_fetch_array($ahay)) {
...
<div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header"><button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal"> Data Inventori Keluar </button></h1>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12">
