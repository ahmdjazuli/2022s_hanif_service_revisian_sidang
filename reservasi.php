<?php require('header.php'); $id = $_GET['id'];
  ...
  $data = mysqli_fetch_array($query); ?>
    	...
    	<div class="container"><br><br><br><br><br>
    	    ...
    	    <div class="row">
    	    <h1 class="new_text text-center"><strong>+Reservasi Service</strong></h1>
	    		<div class="col-md-5">
                    <div class="email_box">
	    			<div class="input_main">
                       <div class="container">
                        ...
                        <div class="form-group">
                            <label>No. Urut</label>
                            <?php $uy = mysqli_fetch_array(mysqli_query($kon, "SELECT * FROM dataservice ORDER BY urut DESC")); ?>
                            <input class="form-control" type="text" name="urut" value="<?= $uy['urut']+1 ?>" readonly>
                        </div>
                       </div>                  
                    </div>
                    </div>
                ...
                <div class="col-md-5">
                    ...
                    <div class="input_main">
                       ...
                       <div class="send_btn">
                        <button class="main_bt" name="simpan" type="submit">Reservasi</button>
                       </div>                   
                    </div>
                    </div>
                </div>
...
<?php
  if (isset($_POST['simpan'])) {
    ...
    $tambah = mysqli_query($kon,"INSERT INTO dataservice(notransaksi,tgl,kerusakan,metode,merk,telpp,alamatp,jenis,barang,namap,urut) VALUES ('$notransaksi','$tgl','$kerusakan','Reservasi','$merk','$telp','$alamat','$jenis','$barang','$nama','$urut')");
    if($tambah){
      ?> <script>alert("Berhasil Disimpan");window.location='service.php';</script> <?php
    }else{
      ?> <script>alert("Gagal Disimpan");window.location='reservasi.php?id=<?= $id ?>';</script> <?php
    }
  }
?>